...
public class GetOrDefaultUtil {
	...
	public String getOrDefaultToString(Map<String, Object> request, String key, Object defualt, String msg)
			throws Exception {
		if (ObjectUtil.isEmpty(request.getOrDefault(key, defualt))) {
	...
	public String getOrDefaultToString(Map<String, Object> request, String key, Object defualt, String msg,
			boolean numeric) throws Exception {
		if (ObjectUtil.isEmpty(request.getOrDefault(key, defualt))) {
			String messages = messageUtils.getMessage(msg);
			throw new TodayChefException(messages, substringCode(msg));
		} else {
	...
	public String getOrDefaultToStringNotNull(Map<String, Object> request, String key, Object defualt)
			throws Exception {
	...
	public String getOrDefaultToStringNotNull(Map<String, Object> request, String key, Object defualt, String msg)
			throws Exception {
		if (request.getOrDefault(key, defualt).equals(null)) {
			String messages = messageUtils.getMessage(msg);
			throw new TodayChefException(messages, substringCode(msg));
	...
	public long getOrDefaultToLong(Map<String, Object> request, String key, Object defualt, String msg)
			throws Exception {
		if (ObjectUtil.isEmpty(request.getOrDefault(key, defualt))) {
			String messages = messageUtils.getMessage(msg);
			throw new TodayChefException(messages, substringCode(msg));
	...
	public int getOrDefaultToInteger(Map<String, Object> request, String key, Object defualt, String msg)
			throws Exception {
		if (ObjectUtil.isEmpty(request.getOrDefault(key, defualt))) {
			String messages = messageUtils.getMessage(msg);
			throw new TodayChefException(messages, substringCode(msg));
	...
	public Long getOrDefaultToLongClass(Map<String, Object> request, String key, Object defualt, String msg)
			throws Exception {
		if (ObjectUtil.isEmpty(request.getOrDefault(key, defualt))) {
			String messages = messageUtils.getMessage(msg);
			throw new TodayChefException(messages, substringCode(msg));
	...
	public char getOrDefaultToChar(Map<String, Object> request, String key, Object defualt, String msg)
			throws Exception {
		if (ObjectUtil.isEmpty(request.getOrDefault(key, defualt))) {
			String messages = messageUtils.getMessage(msg);
			throw new TodayChefException(messages, substringCode(msg));
